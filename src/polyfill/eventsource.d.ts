...
// Source: https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/event-source-polyfill/index.d.ts
...
export interface EventSourceEventMap {
    ...
    "SSEEvent_update": MessageEvent; // custom event added for App Config purpose only
}
